    ...
    gpu: {
      ...
      schema: {
        ...
        'DataFrame/readCSV': {
          ...
          params: {
            filename:
              'The name of the file, stored in the server\'s public/ folder, of the csv file.'
          },
    ...
    particles: {
      ...
      schema: {
        'get_shader_column/:table/:xmin/:xmax/:ymin/:ymax': {
          ...
          result:
            `Returns the Longitude and Latitude columns of a table that has been read previously
    ...
    quadtree: {
      ...
      schema: {
        ...
        'set_polygons': {
          ...
          return:
            {'200': 'Polygon set created successfully.', '500': 'Polygon set creation failed.'}
        },
        'get_points/:quadtree/:polygon': {
          ...
          params: {
            ...
            ':polygon':
              'The name of the polygon set previously created with `quadtree/set_polygons`'
          },
          result:
            'Returns the points that are contained within the polygons specified by :polygon.',
