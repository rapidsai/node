    ...
    render(layers = {}, boxSelectRectData = [], props = {}) {
      ...
      deck.setProps({
        layers: makeLayers(deck, layers)
                  .concat(boxSelectRectData[0].show ? getPolygonLayer(boxSelectRectData) : []),
        ...props
      });
...
module.exports.openLayerIpcHandles  = openGraphIpcHandles;
module.exports.closeLayerIpcHandles = closeGraphIpcHandles;
module.exports.serializeCustomLayer = serializeCustomLayer;
