...
function(_set_interface_include_dirs_as_system target)
    ...
    if (TARGET ${_real})
        get_target_property(_iid ${target} INTERFACE_INCLUDE_DIRECTORIES)
        get_target_property(_isid ${target} INTERFACE_SYSTEM_INCLUDE_DIRECTORIES)
        if (_iid)
            if (NOT _isid)
                set(_isid ${_iid})
            else()
                list(APPEND _isid ${_iid})
            endif()
            set_property(TARGET ${_real} PROPERTY INTERFACE_INCLUDE_DIRECTORIES "")
            target_include_directories(${_real} SYSTEM INTERFACE ${_isid})
        endif()
    endif()
endfunction()
