...
let rootWindow: GLFWDOMWindow | undefined;
...
export abstract class GLFWDOMWindow {
  ...
  public set width(_: number) {
    this._width = this._cssToNumber('width', _);
  }
  ...
  public set height(_: number) {
    this._height = this._cssToNumber('height', _);
  }
  ...
  public get altKey() {
    return isAltKey(this._modifiers);
  }
  public get ctrlKey() {
    return isCtrlKey(this._modifiers);
  }
  public get metaKey() {
    return isMetaKey(this._modifiers);
  }
  public get shiftKey() {
    return isShiftKey(this._modifiers);
  }
  public get capsLock() {
    return isCapsLock(this._modifiers);
  }
  ...
  public set devicePixelRatio(_: number) {
    this._devicePixelRatio = _;
  }
  ...
  public dispatchEvent(event: any) {
    ...
    const button = (() => {
      switch (event && event.button) {
        case 0:
          return GLFWMouseButton.MOUSE_BUTTON_LEFT;
        case 1:
          return GLFWMouseButton.MOUSE_BUTTON_MIDDLE;
        case 2:
          return GLFWMouseButton.MOUSE_BUTTON_RIGHT;
        default:
          return -1;
      }
    })();
  ...
  protected get _clearMask() {
    return this._gl ? this._gl._clearMask : 0;
  }
  protected set _clearMask(_: any) {
    this._gl && (this._gl._clearMask = _);
  }
...
function defineDOMElementPropertyAliases(
  proto: any,
