...
export interface GLFWVersion { major: number; minor: number; rev: number; };
export interface GLFWScale { xscale: number; yscale: number; };
export interface GLFWPosition { x: number; y: number; };
export interface GLFWSize { width: number; height: number; };
export interface GLFWRect { left: number; top: number; right: number; bottom: number; };
export interface GLFWSizeLimits { minWidth: number; minHeight: number; maxWidth: number; maxHeight: number; };
...
export interface GLFWimage {
    ...
    /** The pixel data of this image, arranged left-to-right, top-to-bottom. */ pixels: ArrayBufferLike | ArrayBufferView;
}
...
export namespace glfw {
    ...
    export const getMonitorWorkarea: (monitor: GLFWmonitor) => GLFWPositionAndSize = GLFW.getMonitorWorkarea;
    export const getMonitorPhysicalSize: (monitor: GLFWmonitor) => GLFWSize = GLFW.getMonitorPhysicalSize;
    export const getMonitorContentScale: (monitor: GLFWmonitor) => GLFWScale = GLFW.getMonitorContentScale;
    ...
    export const windowHint: (hint: GLFWWindowAttribute, value: number | boolean) => void = GLFW.windowHint;
    export const windowHintString: (hint: string, value: number | boolean) => void = GLFW.windowHintString;
    export const createWindow: (width: number, height: number, title: string, monitor?: GLFWmonitor | null, root?: GLFWwindow | null) => GLFWwindow = GLFW.createWindow;
    export const reparentWindow: (child: GLFWwindow, parent: GLFWParentWindow, targetX: number, targetY: number) => void = GLFW.reparentWindow;
    ...
    export const setWindowShouldClose: (window: GLFWwindow, shouldClose: boolean) => void = GLFW.setWindowShouldClose;
    ...
    export const setWindowSizeLimits: (window: GLFWwindow, limits: GLFWSizeLimits) => void = GLFW.setWindowSizeLimits;
    export const setWindowAspectRatio: (window: GLFWwindow, num: number, denom: number) => void = GLFW.setWindowAspectRatio;
    ...
    export const setWindowOpacity: (window: GLFWwindow, opacity: number) => void = GLFW.setWindowOpacity;
    ...
    export const setWindowMonitor: (window: GLFWwindow, monitor: GLFWmonitor) => void = GLFW.setWindowMonitor;
    export const getWindowAttrib: (window: GLFWwindow, attribute: GLFWWindowAttribute) => void = GLFW.getWindowAttrib;
    export const setWindowAttrib: (window: GLFWwindow, attribute: GLFWWindowAttribute, value: number | boolean) => void = GLFW.setWindowAttrib;
    ...
    export const setInputMode: (window: GLFWwindow, mode: number, value: number | boolean) => void = GLFW.setInputMode;
    ...
    export const createCursor: (image: GLFWimage, x: number, y: number) => GLFWcursor = GLFW.createCursor;
    ...
    export const setClipboardString: (window: GLFWwindow, value: string) => void = GLFW.setClipboardString;
    ...
    export const setErrorCallback: (callback: null | ((error_code: number, description: string) => void)) => void = GLFW.setErrorCallback;
    export const setMonitorCallback: (callback: null | ((monitor: GLFWmonitor, event: number) => void)) => void = GLFW.setMonitorCallback;
    export const setJoystickCallback: (callback: null | ((joystick: number, event: number) => void)) => void = GLFW.setJoystickCallback;
    export const setWindowPosCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow, x: number, y: number) => void)) => void = GLFW.setWindowPosCallback;
    export const setWindowSizeCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow, width: number, height: number) => void)) => void = GLFW.setWindowSizeCallback;
    export const setWindowCloseCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow) => void)) => void = GLFW.setWindowCloseCallback;
    export const setWindowRefreshCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow) => void)) => void = GLFW.setWindowRefreshCallback;
    export const setWindowFocusCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow, focused: boolean) => void)) => void = GLFW.setWindowFocusCallback;
    export const setWindowIconifyCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow, iconified: boolean) => void)) => void = GLFW.setWindowIconifyCallback;
    export const setWindowMaximizeCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow, maximized: boolean) => void)) => void = GLFW.setWindowMaximizeCallback;
    export const setFramebufferSizeCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow, width: number, height: number) => void)) => void = GLFW.setFramebufferSizeCallback;
    export const setWindowContentScaleCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow, xscale: number, yscale: number) => void)) => void = GLFW.setWindowContentScaleCallback;
    export const setKeyCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow, key: number, scancode: number, action: number, mods: number) => void)) => void = GLFW.setKeyCallback;
    export const setCharCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow, code: number) => void)) => void = GLFW.setCharCallback;
    export const setCharModsCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow, code: number, mods: number) => void)) => void = GLFW.setCharModsCallback;
    export const setMouseButtonCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow, button: number, action: number, mods: number) => void)) => void = GLFW.setMouseButtonCallback;
    export const setCursorPosCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow, x: number, y: number) => void)) => void = GLFW.setCursorPosCallback;
    export const setCursorEnterCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow, entered: number) => void)) => void = GLFW.setCursorEnterCallback;
    export const setScrollCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow, xoffset: number, yoffset: number) => void)) => void = GLFW.setScrollCallback;
    export const setDropCallback: (window: GLFWwindow, callback: null | ((window: GLFWwindow, items: string[]) => void)) => void = GLFW.setDropCallback;

    // export const getInstanceProcAddress: () => void = GLFW.getInstanceProcAddress;
    // export const getPhysicalDevicePresentationSupport: () => void = GLFW.getPhysicalDevicePresentationSupport;
