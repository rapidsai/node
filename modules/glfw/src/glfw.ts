...
export namespace glfw {
  ...
  export const getMonitorWorkarea: (monitor: GLFWmonitor) => GLFWPositionAndSize =
    GLFW.getMonitorWorkarea;
  export const getMonitorPhysicalSize: (monitor: GLFWmonitor) => GLFWSize =
  ...
  export const setGammaRamp: (monitor: GLFWmonitor, rapi: GLFWgammaramp) => void =
    GLFW.setGammaRamp;
  export const defaultWindowHints: () => void = GLFW.defaultWindowHints;
  export const windowHint: (hint: GLFWWindowAttribute, value: number | boolean) => void =
    GLFW.windowHint;
  export const windowHintString: (hint: string, value: number | boolean) => void =
  ...
  export const setWindowShouldClose: (window: GLFWwindow, shouldClose: boolean) => void =
  ...
  export const setWindowPos: (window: GLFWwindow, position: GLFWPosition) => void =
    GLFW.setWindowPos;
  export const getWindowSize: (window: GLFWwindow) => GLFWSize = GLFW.getWindowSize;
  export const setWindowSizeLimits: (window: GLFWwindow, limits: GLFWSizeLimits) => void =
    GLFW.setWindowSizeLimits;
  export const setWindowAspectRatio: (window: GLFWwindow, num: number, denom: number) => void =
  ...
  export const getWindowContentScale: (window: GLFWwindow) => GLFWScale =
    GLFW.getWindowContentScale;
  export const getWindowOpacity: (window: GLFWwindow) => number = GLFW.getWindowOpacity;
  export const setWindowOpacity: (window: GLFWwindow, opacity: number) => void =
  ...
  export const setWindowMonitor: (window: GLFWwindow, monitor: GLFWmonitor) => void =
    GLFW.setWindowMonitor;
  export const getWindowAttrib: (window: GLFWwindow, attribute: GLFWWindowAttribute) => void =
    GLFW.getWindowAttrib;
  export const setWindowAttrib: (
    window: GLFWwindow,
  ...
  export const setInputMode: (window: GLFWwindow, mode: number, value: number | boolean) => void =
    GLFW.setInputMode;
  ...
  export const setCursorPos: (window: GLFWwindow, position: GLFWPosition) => void =
    GLFW.setCursorPos;
  export const createCursor: (image: GLFWimage, x: number, y: number) => GLFWcursor =
    GLFW.createCursor;
  ...
  export const setClipboardString: (window: GLFWwindow, value: string) => void =
  ...
  export const setErrorCallback: (
    callback: null | ((error_code: number, description: string) => void),
  ) => void = GLFW.setErrorCallback;
  ...
  export const setJoystickCallback: (
    callback: null | ((joystick: number, event: number) => void),
  ) => void = GLFW.setJoystickCallback;
  export const setWindowPosCallback: (
    window: GLFWwindow,
    callback: null | ((window: GLFWwindow, x: number, y: number) => void),
  ) => void = GLFW.setWindowPosCallback;
  ...
  ) => void = GLFW.setWindowCloseCallback;
  ...
  export const setWindowFocusCallback: (
    window: GLFWwindow,
    callback: null | ((window: GLFWwindow, focused: boolean) => void),
  ) => void = GLFW.setWindowFocusCallback;
  export const setWindowIconifyCallback: (
    window: GLFWwindow,
    callback: null | ((window: GLFWwindow, iconified: boolean) => void),
  ) => void = GLFW.setWindowIconifyCallback;
  export const setWindowMaximizeCallback: (
    window: GLFWwindow,
    callback: null | ((window: GLFWwindow, maximized: boolean) => void),
  ) => void = GLFW.setWindowMaximizeCallback;
  ...
  export const setWindowContentScaleCallback: (
    window: GLFWwindow,
    callback: null | ((window: GLFWwindow, xscale: number, yscale: number) => void),
  ) => void = GLFW.setWindowContentScaleCallback;
  ...
  export const setCharCallback: (
    window: GLFWwindow,
    callback: null | ((window: GLFWwindow, code: number) => void),
  ) => void = GLFW.setCharCallback;
