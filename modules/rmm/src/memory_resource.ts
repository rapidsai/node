...
export interface CudaMemoryResource extends MemoryResource { }
...
export interface ManagedMemoryResource extends MemoryResource { }
...
export interface PoolMemoryResourceConstructor {
     ...
     */
    new(upstreamMemoryResource: MemoryResource, initialPoolSize?: number, maximumPoolSize?: number): PoolMemoryResource;
}
...
export interface FixedSizeMemoryResourceConstructor {
     ...
     */
    new(upstreamMemoryResource: MemoryResource, blockSize?: number, blocksToPreallocate?: number): FixedSizeMemoryResource;
}
...
export const FixedSizeMemoryResource: FixedSizeMemoryResourceConstructor = RMM.FixedSizeMemoryResource;
...
export interface BinningMemoryResourceConstructor {
     ...
     */
    new(upstreamMemoryResource: MemoryResource, minSizeExponent?: number, maxSizeExponent?: number): BinningMemoryResource;
}
