...
test('Table.select', () => {
    ...
    const table_0 = new Table(
        {data:{"col_0":col_0, "col_1": col_1, "col_2": col_2, "col_3": col_3}});
    ...
    expect(table_0.select(["col_0", "col_3"])).toStrictEqual(
        new Table({data:{"col_0": col_0, "col_3": col_3}})
    );
});
...
test('Table.slice', () => {
    ...
    const table_0 = new Table({data:{"col_0":col_0, "col_1": col_1, "col_2": col_2, "col_3": col_3}});
    ...
    expect(table_0.slice(2, 3)).toStrictEqual(
        new Table({data:{"col_2": col_0, "col_3": col_3}})
    );
    expect(table_0.slice("col_1", "col_3")).toStrictEqual(
        new Table({data:{"col_1": col_1, "col_2": col_2, "col_3": col_3}})
    );
