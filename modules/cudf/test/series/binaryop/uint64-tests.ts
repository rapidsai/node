...
describe('Series binaryops (Uint64)', () => {
  ...
  describe('Series.true_div', () => {
    test('true_divides by a Series', () => {
      const {lhs, rhs} = makeTestData();
      // lhs / lhs == [0/0, 1/1, 2/2]
      expect([...lhs.true_div(lhs)].map(Number)).toEqual([9223372036854776000, 1, 1]);
      // lhs / rhs == [0/1, 1/2, 2/3]
  ...
  describe('Series.floor_div', () => {
    test('floor_divides by a Series', () => {
      ...
      expect([...lhs.floor_div(lhs)].map(Number)).toEqual([9223372036854776000, 1, 1]);
  ...
  describe('Series.bitwise_or', () => {
    ...
    test('bitwise_or with a scalar', () => {
      const {lhs} = makeTestData();
      expect([...lhs.bitwise_or(-1)].map(Number))
        .toEqual([18446744073709552000, 18446744073709552000, 18446744073709552000]);
    ...
    test('bitwise_or with a bigint', () => {
      const {lhs} = makeTestData();
      expect([...lhs.bitwise_or(-1n)].map(Number))
        .toEqual([18446744073709552000, 18446744073709552000, 18446744073709552000]);
  ...
  describe('Series.bitwise_xor', () => {
    ...
    test('bitwise_xor with a scalar', () => {
      const {lhs} = makeTestData();
      expect([...lhs.bitwise_xor(-1)].map(Number))
        .toEqual([18446744073709552000, 18446744073709552000, 18446744073709552000]);
    ...
    test('bitwise_xor with a bigint', () => {
      const {lhs} = makeTestData();
      expect([...lhs.bitwise_xor(-1n)].map(Number))
        .toEqual([18446744073709552000, 18446744073709552000, 18446744073709552000]);
  ...
  describe('Series.log_base', () => {
    test('log_base with a Series', () => {
      const {lhs, rhs} = makeTestData();
      // lhs || lhs == [0 || 0, 1 || 1, 2 || 2])
      expect([...lhs.log_base(lhs)].map(Number))
    ...
    test('log_base with a bigint', () => {
      ...
      expect([...lhs.log_base(2n)].map(Number)).toEqual([0, 0, 1]);
    });
  });
  ...
  describe('Series.null_max', () => {
    ...
    test('null_max with a bigint', () => {
      const {lhs} = makeTestData();
      expect([...lhs.null_max(-1n)].map(Number))
        .toEqual([18446744073709552000, 18446744073709552000, 18446744073709552000]);
  ...
  describe('Series.null_min', () => {
    ...
    test('null_min with a bigint', () => {
      const {lhs} = makeTestData();
      expect([...lhs.null_min(-1n)].map(Number)).toEqual([0, 1, 2]);
