  ...
  Napi::Function ctor =
    DefineClass(env,
                "Column",
                {
                  ...
                  InstanceMethod<&Column::arcsin>("arcsin"),
                  InstanceMethod<&Column::arccos>("arccos"),
                  InstanceMethod<&Column::arctan>("arctan"),
                  InstanceMethod<&Column::sinh>("sinh"),
                  InstanceMethod<&Column::cosh>("cosh"),
                  InstanceMethod<&Column::tanh>("tanh"),
                  InstanceMethod<&Column::arcsinh>("arcsinh"),
                  InstanceMethod<&Column::arccosh>("arccosh"),
                  InstanceMethod<&Column::arctanh>("arctanh"),
