...
//     /**
//      * @summary Creates a new {@link CUDADevice} at the given ordinal with the specified {@link DeviceFlag} flags.
//      * @param {DeviceFlag} flags The flags for the device's primary context.
//      * @see {@link CUDADevice.prototype.reset}
//      */
//     public static new(deviceIndex: number, flags: DeviceFlag = DeviceFlag.scheduleAuto) {
//         return new CUDADevice(deviceIndex, flags);
//     }

//     private constructor(deviceIndex: number, flags: DeviceFlag = DeviceFlag.scheduleAuto) {
...
//      *  of potentially increased memory usage.
//      */
//     public reset(flags: DeviceFlag = DeviceFlag.scheduleAuto) {
...
//      * @summary Queries the {@link DeviceFlag} flags used to initialize this device.
//      */
//     public getFlags() { return this.callInContext(() => CUDA.device.getFlags() - DeviceFlag.mapHost); }
