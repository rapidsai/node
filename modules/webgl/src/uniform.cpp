...
Napi::Value glGetUniformbv(Napi::Env const& env,
  ...
  if (size == 1) {
    return ToNapi(env)(bools[0]);
  } else {
    return ToNapi(env)(bools);
  }
}
...
Napi::Value WebGL2RenderingContext::GetActiveUniform(Napi::CallbackInfo const& info) {
  ...
  if (max_length > 0) {
    ...
    GL_EXPORT::glGetActiveUniform(
      program, FromJS(info[1]), max_length, &length, &size, &type, name);
    return ToNapi(env)({"size", "type", "name"},
...
Napi::Value WebGL2RenderingContext::GetUniform(Napi::CallbackInfo const& info) {
  auto env       = info.Env();
  GLuint program = FromJS(info[0]);
  GLint location = FromJS(info[1]);
  if (location < 0) { return env.Null(); }
  GLint size{};
  GLuint type{};
...
Napi::Value WebGL2RenderingContext::Uniform1f(Napi::CallbackInfo const& info) {
  auto env  = info.Env();
  GLint loc = FromJS(info[0]);
  GL_EXPORT::glUniform1f(loc, FromJS(info[1]));
...
Napi::Value WebGL2RenderingContext::Uniform1fv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLfloat*> ptr = FromJS(info[1]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniform1fv(loc, ptr.first / size, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform1i(Napi::CallbackInfo const& info) {
  auto env  = info.Env();
  GLint loc = FromJS(info[0]);
  GL_EXPORT::glUniform1i(loc, FromJS(info[1]));
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform1iv(Napi::CallbackInfo const& info) {
  ...
  GLint loc = FromJS(info[0]);
  static constexpr GLint size{1};
  std::pair<size_t, GLint*> ptr = FromJS(info[1]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniform1iv(loc, ptr.first / size, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform2f(Napi::CallbackInfo const& info) {
  auto env  = info.Env();
  GLint loc = FromJS(info[0]);
  GL_EXPORT::glUniform2f(loc, FromJS(info[1]), FromJS(info[2]));
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform2fv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLfloat*> ptr = FromJS(info[1]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniform2fv(loc, ptr.first / size, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform2i(Napi::CallbackInfo const& info) {
  auto env  = info.Env();
  GLint loc = FromJS(info[0]);
  GL_EXPORT::glUniform2i(loc, FromJS(info[1]), FromJS(info[2]));
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform2iv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLint*> ptr = FromJS(info[1]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniform2iv(loc, ptr.first / size, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform3f(Napi::CallbackInfo const& info) {
  auto env  = info.Env();
  GLint loc = FromJS(info[0]);
  GL_EXPORT::glUniform3f(loc, FromJS(info[1]), FromJS(info[2]), FromJS(info[3]));
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform3fv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLfloat*> ptr = FromJS(info[1]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniform3fv(loc, ptr.first / size, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform3i(Napi::CallbackInfo const& info) {
  auto env  = info.Env();
  GLint loc = FromJS(info[0]);
  GL_EXPORT::glUniform3i(loc, FromJS(info[1]), FromJS(info[2]), FromJS(info[3]));
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform3iv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLint*> ptr = FromJS(info[1]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniform3iv(loc, ptr.first / size, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform4f(Napi::CallbackInfo const& info) {
  auto env  = info.Env();
  GLint loc = FromJS(info[0]);
  GL_EXPORT::glUniform4f(loc, FromJS(info[1]), FromJS(info[2]), FromJS(info[3]), FromJS(info[4]));
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform4fv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLfloat*> ptr = FromJS(info[1]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniform4fv(loc, ptr.first / size, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform4i(Napi::CallbackInfo const& info) {
  auto env  = info.Env();
  GLint loc = FromJS(info[0]);
  GL_EXPORT::glUniform4i(loc, FromJS(info[1]), FromJS(info[2]), FromJS(info[3]), FromJS(info[4]));
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform4iv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLint*> ptr = FromJS(info[1]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniform4iv(loc, ptr.first / size, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::UniformMatrix2fv(Napi::CallbackInfo const& info) {
  auto env       = info.Env();
  GLint loc      = FromJS(info[0]);
  bool transpose = FromJS(info[1]);
  static constexpr GLint size{2 * 2};
  std::pair<size_t, GLfloat*> ptr = FromJS(info[2]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniformMatrix2fv(loc, ptr.first / size, transpose, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::UniformMatrix3fv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLfloat*> ptr = FromJS(info[2]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniformMatrix3fv(loc, ptr.first / size, transpose, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::UniformMatrix4fv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLfloat*> ptr = FromJS(info[2]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniformMatrix4fv(loc, ptr.first / size, transpose, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::UniformMatrix2x3fv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLfloat*> ptr = FromJS(info[2]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniformMatrix2x3fv(loc, ptr.first / size, transpose, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::UniformMatrix2x4fv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLfloat*> ptr = FromJS(info[2]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniformMatrix2x4fv(loc, ptr.first / size, transpose, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::UniformMatrix3x2fv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLfloat*> ptr = FromJS(info[2]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniformMatrix3x2fv(loc, ptr.first / size, transpose, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::UniformMatrix3x4fv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLfloat*> ptr = FromJS(info[2]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniformMatrix3x4fv(loc, ptr.first / size, transpose, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::UniformMatrix4x2fv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLfloat*> ptr = FromJS(info[2]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniformMatrix4x2fv(loc, ptr.first / size, transpose, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::UniformMatrix4x3fv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLfloat*> ptr = FromJS(info[2]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniformMatrix4x3fv(loc, ptr.first / size, transpose, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform1ui(Napi::CallbackInfo const& info) {
  auto env  = info.Env();
  GLint loc = FromJS(info[0]);
  GL_EXPORT::glUniform1ui(loc, FromJS(info[1]));
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform1uiv(Napi::CallbackInfo const& info) {
  ...
  GLint loc = FromJS(info[0]);
  static constexpr GLint size{1};
  std::pair<size_t, GLuint*> ptr = FromJS(info[1]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniform1uiv(loc, ptr.first / size, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform2ui(Napi::CallbackInfo const& info) {
  auto env  = info.Env();
  GLint loc = FromJS(info[0]);
  GL_EXPORT::glUniform2ui(loc, FromJS(info[1]), FromJS(info[2]));
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform2uiv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLuint*> ptr = FromJS(info[1]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniform2uiv(loc, ptr.first / size, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform3ui(Napi::CallbackInfo const& info) {
  auto env  = info.Env();
  GLint loc = FromJS(info[0]);
  GL_EXPORT::glUniform3ui(loc, FromJS(info[1]), FromJS(info[2]), FromJS(info[3]));
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform3uiv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLuint*> ptr = FromJS(info[1]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniform3uiv(loc, ptr.first / size, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform4ui(Napi::CallbackInfo const& info) {
  auto env  = info.Env();
  GLint loc = FromJS(info[0]);
  GL_EXPORT::glUniform4ui(loc, FromJS(info[1]), FromJS(info[2]), FromJS(info[3]), FromJS(info[4]));
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::Uniform4uiv(Napi::CallbackInfo const& info) {
  ...
  std::pair<size_t, GLuint*> ptr = FromJS(info[1]);
  if ((ptr.first < size) || (ptr.first % size) != 0) { GLEW_THROW(env, GL_INVALID_VALUE); }
  GL_EXPORT::glUniform4uiv(loc, ptr.first / size, ptr.second);
  return env.Undefined();
}
...
Napi::Value WebGL2RenderingContext::GetActiveUniformBlockName(Napi::CallbackInfo const& info) {
  ...
  if (max_length > 0) {
    GLint length{};
    GLchar* name = reinterpret_cast<GLchar*>(std::malloc(max_length));
    GL_EXPORT::glGetActiveUniformBlockName(program, FromJS(info[1]), max_length, &length, name);
    return ToNapi(env)(std::string{name, static_cast<size_t>(length)});
  }
  return env.Null();
}
...
Napi::Value WebGL2RenderingContext::GetActiveUniformBlockiv(Napi::CallbackInfo const& info) {
  auto env = info.Env();
  GLint params{};
  GL_EXPORT::glGetActiveUniformBlockiv(FromJS(info[0]), FromJS(info[1]), FromJS(info[2]), &params);
  return ToNapi(env)(params);
}
...
Napi::Value WebGL2RenderingContext::GetActiveUniformsiv(Napi::CallbackInfo const& info) {
  auto env = info.Env();
  GLint params{};
  GL_EXPORT::glGetActiveUniformsiv(
    FromJS(info[0]), FromJS(info[1]), FromJS(info[2]), FromJS(info[3]), &params);
  return ToNapi(env)(params);
}
...
Napi::Value WebGL2RenderingContext::GetUniformBlockIndex(Napi::CallbackInfo const& info) {
  auto env                     = info.Env();
  GLuint program               = FromJS(info[0]);
  std::string uniformBlockName = FromJS(info[1]);
  return ToNapi(env)(GL_EXPORT::glGetUniformBlockIndex(program, uniformBlockName.data()));
}
...
Napi::Value WebGL2RenderingContext::GetUniformIndices(Napi::CallbackInfo const& info) {
  auto env                               = info.Env();
  GLuint program                         = FromJS(info[0]);
  std::vector<std::string> uniform_names = FromJS(info[1]);
  ...
  return ToNapi(env)(uniform_indices);
}
...
Napi::Value WebGL2RenderingContext::UniformBlockBinding(Napi::CallbackInfo const& info) {
  auto env = info.Env();
  GL_EXPORT::glUniformBlockBinding(FromJS(info[0]), FromJS(info[1]), FromJS(info[2]));
  return env.Undefined();
}
