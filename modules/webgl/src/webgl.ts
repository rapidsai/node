...
function bufferData(this: WebGL2RenderingContext, target: GLenum, size: GLsizeiptr, usage: GLenum): void;
function bufferData(this: WebGL2RenderingContext, target: GLenum, srcData: BufferSource | null, usage: GLenum): void;
function bufferData(this: WebGL2RenderingContext, target: GLenum, srcData: ArrayBufferView, usage: GLenum, srcOffset: GLuint, srcByteLength?: GLuint): void;
...
function bufferSubData(this: WebGL2RenderingContext, target: GLenum, offset: GLintptr, data: BufferSource): void;
function bufferSubData(this: WebGL2RenderingContext, target: GLenum, dstByteOffset: GLintptr, srcData: BufferSource): void;
function bufferSubData(this: WebGL2RenderingContext, target: GLenum, dstByteOffset: GLintptr, srcData: ArrayBufferView, srcOffset: GLuint, srcByteLength?: GLuint): void;
...
function getBufferSubData(this: WebGL2RenderingContext, target: GLenum, srcByteOffset: GLintptr, dst: ArrayBufferView, dstOffset: GLuint = 0, length?: GLuint): void {
...
function getShaderInfoLog(this: WebGL2RenderingContext, shader: WebGLShader): string {
    ...
    return lines.map((line) => {
        ...
        ({ index: errIndex, [0]: errMatch, [1]: type } = (lines[0] || '').match(/\s?(warning|error) (\w+|\d+):/) || { ...['', ''] });
        ({ index: numIndex, [0]: numMatch, [1]: num } = (line.match(/0\((\d+)\) \:/) || { ...['', ''] }));
        if (errIndex !== undefined && numIndex !== undefined && errMatch && type && numMatch && num) {
            return `${type.toUpperCase()}:${
                line.slice(errIndex + errMatch.length)}:${
                num}${line.slice(numIndex + numMatch.length)}`;
        }
        return line;
    }).join('\n');
}
...
function texImage2D(this: WebGL2RenderingContext, target: GLenum, level: GLint, internalformat: GLint, format: GLenum, type: GLenum, source: TexImageSource): void;
function texImage2D(this: WebGL2RenderingContext, target: GLenum, level: GLint, internalformat: GLint, width: GLsizei, height: GLsizei, border: GLint, format: GLenum, type: GLenum, pboOffset: GLintptr): void;
function texImage2D(this: WebGL2RenderingContext, target: GLenum, level: GLint, internalformat: GLint, width: GLsizei, height: GLsizei, border: GLint, format: GLenum, type: GLenum, source: TexImageSource): void;
function texImage2D(this: WebGL2RenderingContext, target: GLenum, level: GLint, internalformat: GLint, width: GLsizei, height: GLsizei, border: GLint, format: GLenum, type: GLenum, srcData?: ArrayBufferView | null, srcOffset?: GLuint): void;
function texImage2D(this: WebGL2RenderingContext, ...args: [GLenum, GLint, GLint, GLsizei | GLenum, GLsizei | GLenum, GLint | TexImageSource, GLenum?, GLenum?, (GLintptr | TexImageSource | ArrayBufferView | null)?, GLsizei?]): void {
    ...
    switch (args.length) {
        case 6: {
            [target, level, internalformat, format, type, src] = (args as [GLenum, GLint, GLint, GLenum, GLenum, TexImageSource]);
        ...
        case 8: case 9: case 10: {
            if (typeof args[8] === 'number') {
                [target, level, internalformat, width, height, border, format, type, src] = (args as [GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, GLintptr]);
                break;
            }
            if (args[8] === null || args[8] === undefined || ArrayBuffer.isView(args[8]) || (args[8] instanceof ArrayBuffer)) {
                [target, level, internalformat, width, height, border, format, type, src] = (args as [GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, ArrayBufferView]);
                src = toArrayBufferViewSlice(src, offset);
                break;
            }
            if (args[8] && typeof args[8] === 'object') {
                [target, level, internalformat, width, height, border, format, type, src] = (args as [GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, TexImageSource]);
    ...
    return gl_texImage2D.call(this, target, level, internalformat, width, height, border, format, type, src);
}
...
function texSubImage2D(this: WebGL2RenderingContext, target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, width: GLsizei, height: GLsizei, format: GLenum, type: GLenum, pixels: ArrayBufferView | null): void;
function texSubImage2D(this: WebGL2RenderingContext, target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, format: GLenum, type: GLenum, source: TexImageSource): void;
function texSubImage2D(this: WebGL2RenderingContext, target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, width: GLsizei, height: GLsizei, format: GLenum, type: GLenum, pboOffset: GLintptr): void;
function texSubImage2D(this: WebGL2RenderingContext, target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, width: GLsizei, height: GLsizei, format: GLenum, type: GLenum, source: TexImageSource): void;
function texSubImage2D(this: WebGL2RenderingContext, target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, width: GLsizei, height: GLsizei, format: GLenum, type: GLenum, srcData?: ArrayBufferView | null, srcOffset?: GLuint): void;
function texSubImage2D(this: WebGL2RenderingContext, ...args: [GLenum, GLint, GLint, GLint, GLenum | GLsizei, GLenum | GLsizei, GLenum | TexImageSource, GLenum?, (GLintptr | TexImageSource | ArrayBufferView | null)?, GLuint?]): void {
    ...
    switch (args.length) {
        case 7: {
            [target, level, x, y, format, type, src] = (args as [GLenum, GLint, GLint, GLint, GLenum, GLenum, TexImageSource]);
            src = pixelsFromImage(src, width = src.width, height = src.height);
            break;
        }
        case 8: case 9: case 10: {
            if (typeof args[8] === 'number') {
                [target, level, x, y, width, height, format, type, src] = (args as [GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, GLintptr]);
                break;
            }
            if (args[8] === null || args[8] === undefined || ArrayBuffer.isView(args[8]) || (args[8] instanceof ArrayBuffer)) {
                [target, level, x, y, width, height, format, type, src] = (args as [GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, ArrayBufferView | null]);
                src = toArrayBufferViewSlice(src, offset);
                break;
            }
            if (args[8] && typeof args[8] === 'object') {
                [target, level, x, y, width, height, format, type, src] = (args as [GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, TexImageSource]);
                [width = src.width, height = src.height] = [width, height];
                src = pixelsFromImage(src, width, height);
                break;
            }
        ...
        default: throw new TypeError('WebGLRenderingContext texSubImage2D() takes 7, 9, or 10 arguments');
    }
...
function readPixels(this: WebGL2RenderingContext, x: GLint, y: GLint, width: GLsizei, height: GLsizei, format: GLenum, type: GLenum, dstData: ArrayBufferView | null): void;
function readPixels(this: WebGL2RenderingContext, x: GLint, y: GLint, width: GLsizei, height: GLsizei, format: GLenum, type: GLenum, offset: GLintptr): void;
function readPixels(this: WebGL2RenderingContext, x: GLint, y: GLint, width: GLsizei, height: GLsizei, format: GLenum, type: GLenum, dstData: ArrayBufferView, dstOffset: GLuint): void;
    ...
    switch (args.length) {
        case 6: case 7: {
            if (typeof args[6] === 'number') {
                [x, y, width, height, format, type, dst] = (args as [GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, GLintptr]);
                break;
            }
            if (args[6] === null || args[6] === undefined || ArrayBuffer.isView(args[6]) || (args[6] instanceof ArrayBuffer)) {
...
function uniformMatrix2fv(this: WebGL2RenderingContext, location: WebGLUniformLocation | null, transpose: GLboolean, data: Float32List, offset: GLuint = 0, length: GLuint = data.length): void {
...
function uniformMatrix3fv(this: WebGL2RenderingContext, location: WebGLUniformLocation | null, transpose: GLboolean, data: Float32List, offset: GLuint = 0, length: GLuint = data.length): void {
    if (ArrayBuffer.isView(data)) { data = data.subarray(offset, offset + length); }
...
function uniformMatrix4fv(this: WebGL2RenderingContext, location: WebGLUniformLocation | null, transpose: GLboolean, data: Float32List, offset: GLuint = 0, length: GLuint = data.length): void {
    if (ArrayBuffer.isView(data)) { data = data.subarray(offset, offset + length); }
...
function uniformMatrix2x3fv(this: WebGL2RenderingContext, location: WebGLUniformLocation | null, transpose: GLboolean, data: Float32List, offset: GLuint = 0, length: GLuint = data.length): void {
    if (ArrayBuffer.isView(data)) { data = data.subarray(offset, offset + length); }
...
function uniformMatrix2x4fv(this: WebGL2RenderingContext, location: WebGLUniformLocation | null, transpose: GLboolean, data: Float32List, offset: GLuint = 0, length: GLuint = data.length): void {
    if (ArrayBuffer.isView(data)) { data = data.subarray(offset, offset + length); }
...
function uniformMatrix3x2fv(this: WebGL2RenderingContext, location: WebGLUniformLocation | null, transpose: GLboolean, data: Float32List, offset: GLuint = 0, length: GLuint = data.length): void {
    if (ArrayBuffer.isView(data)) { data = data.subarray(offset, offset + length); }
...
function uniformMatrix3x4fv(this: WebGL2RenderingContext, location: WebGLUniformLocation | null, transpose: GLboolean, data: Float32List, offset: GLuint = 0, length: GLuint = data.length): void {
    if (ArrayBuffer.isView(data)) { data = data.subarray(offset, offset + length); }
...
function uniformMatrix4x2fv(this: WebGL2RenderingContext, location: WebGLUniformLocation | null, transpose: GLboolean, data: Float32List, offset: GLuint = 0, length: GLuint = data.length): void {
    if (ArrayBuffer.isView(data)) { data = data.subarray(offset, offset + length); }
...
function uniformMatrix4x3fv(this: WebGL2RenderingContext, location: WebGLUniformLocation | null, transpose: GLboolean, data: Float32List, offset: GLuint = 0, length: GLuint = data.length): void {
    if (ArrayBuffer.isView(data)) { data = data.subarray(offset, offset + length); }
...
function wrapAndLogGLMethods(proto: any) {
    const listToString = (x: any) => {
        if (x.length < 10) {
            return `(length=${x.length}, values=[${x}])`;
        }
        return `(length=${x.length
            }, values=[${x.slice(0, 3)
            }, ... ${x.slice((x.length >> 1) - 2, (x.length >> 1) + 1)
...
function pixelsFromImage(source: TexImageSource, width: number, height: number) {
    if ((typeof HTMLImageElement !== 'undefined') && (source instanceof HTMLImageElement) ||
        (typeof HTMLVideoElement !== 'undefined') && (source instanceof HTMLVideoElement) && source.ownerDocument) {
        ...
        return <Uint8ClampedArray>source.data;
    }
    throw new TypeError('OpenGLESRenderingContext invalid pixel source');
}
...
const extensionsMap: any = {
    ...
    WEBGL_debug_shaders: {
        getTranslatedShaderSource: gl.getTranslatedShaderSource || (() => { })
    },
    WEBGL_depth_texture: {
